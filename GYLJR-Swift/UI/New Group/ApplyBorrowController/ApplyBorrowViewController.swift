...
class ApplyBorrowViewController: BaseViewController {
    ...
    var chooseBusinessView: UIView?
    var applyView: UIView?
    var handMaterialView: UIView?
    ...
    func initUI() {
        ...
        headerView = UIView(frame: ShiPei.CGRectMakeScaleWith(x: 0, y: 0, width: 375, height: 140))
        ...
        //填写融资申请
        let applyLB = Tool.createLabelWith(title: "2", textColor: kWhiteColor, bgColor: kGoldColor, textFont: 14, textAlignment: NSTextAlignment.center, isFitFont: true)
        ...
        //上传必需材料
        let materialLB = Tool.createLabelWith(title: "3", textColor: kWhiteColor, bgColor: kGoldColor, textFont: 14, textAlignment: NSTextAlignment.center, isFitFont: true)
        ...
        let materialTitleLB = Tool.createLabelWith(title: "上传必需的材料", textColor: kGoldColor, bgColor: nil, textFont: 13, textAlignment: NSTextAlignment.center, isFitFont: true)
    ...
    func changeViewWith(_ index: Int, isNext: Bool)  {
        ...
        if index == 0 {
            if chooseBusinessView == nil {
                chooseBusinessView = ChooseBusinessView()
            }
